...
# 6. Wähle nur 10% der Trainingsdaten aus
train_dataset_small = train_dataset.train_test_split(test_size=0.001)["test"]  # Nimm 10% der Trainingsdaten

# 7. Definiere die Trainingsargumente
...
trainer = Trainer(
    ...
    train_dataset=train_dataset_small,  # Verwende die kleineren Trainingsdaten
